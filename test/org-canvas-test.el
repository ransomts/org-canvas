    ...
    (let ((call-order nil))
      (with-sync-test-env
        (cl-letf (((symbol-function 'org-canvas--preflight-check)
                  ...
                  ((symbol-function 'org-canvas-pull-grading-periods)
                   (lambda () (push 'grading-periods call-order)))
                  ((symbol-function 'org-canvas-pull-grading-schemes)
                   (lambda () (push 'grading-schemes call-order)))
                  ((symbol-function 'org-canvas-pull-people)
                   (lambda () (push 'people call-order)))
                  ((symbol-function 'org-canvas-pull-gradebook)
                   (lambda () (push 'gradebook call-order)))
                  ((symbol-function 'org-canvas-pull-rubric-results)
                   (lambda () (push 'rubric-results call-order)))
                  ((symbol-function 'org-canvas-pull-quiz-results)
                   (lambda () (push 'quiz-results call-order)))
                  ...
                  ((symbol-function 'org-canvas-sync-grading-schemes)
                   (lambda () (push 'grading-schemes call-order)))
                  ...
                  ((symbol-function 'org-canvas-sync-quiz-accommodations)
                   (lambda () (push 'quiz-accommodations call-order)))
  ...
  (it "emits tier progress messages during sync"
    (with-sync-test-env
      ...
      (cl-letf (((symbol-function 'org-canvas--preflight-check) (lambda () nil))
                ...
                ((symbol-function 'org-canvas-pull-grading-periods) (lambda () nil))
                ((symbol-function 'org-canvas-pull-grading-schemes) (lambda () nil))
                ((symbol-function 'org-canvas-pull-people) (lambda () nil))
                ((symbol-function 'org-canvas-pull-gradebook) (lambda () nil))
                ((symbol-function 'org-canvas-pull-rubric-results) (lambda () nil))
                ((symbol-function 'org-canvas-pull-quiz-results) (lambda () nil))
                ...
                ((symbol-function 'org-canvas-sync-grading-schemes) (lambda () nil))
  ...
  (it "calls all pull functions in dependency order"
    (let ((call-order nil))
      (with-sync-test-env
        ...
        ;; Every pull in the tiers was called, once each
        (expect (length call-order)
                :to-equal (apply #'+ (mapcar #'length org-canvas--pull-tiers)))))))
