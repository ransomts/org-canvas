...
| LTI assignments and no Turnitin, the Turnitin document processor as a Canvas-owned property (#184), quiz publish sequencing (#59), rubrics update in place (#123) and keep their criterion ids and assignments (#255, #256), bulk publish (#47), module items reconcile moves (#105), module items adopt a twin before POST and the drift report lists item twins (#177, #179), drift report bodies (#83), by-design extras (#98, #102, #111), drift report verbs (#103), stamp adoption for a CHANGED row with nothing to compare (#257), batch-mode file handling (#97, #121, #188, #249), rubric assessments from the grading file (#250) and their comments as items under the table (#263), comments and drafts as paragraphs and short CONFLICT values (#264), the rubric in full in the grading file (#265), hard-break markup dropped from bodies (#266), Canvas-owned submission types (#167), read-only validation (#168), batch reports (#155, #169), timestamp precision (#176), body headings and the pull entry-count guard (#175), assignment reads ask for their own dates and quizzes do not need to (#273) | `decisions.org` |
