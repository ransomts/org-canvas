...
│                                #   grading-periods (pull-only), group-categories, groups (pull-only),
│                                #   gradebook (pull-only), people (pull-only),
